...
```{r}
data1112 <- read.csv("./data/data1112.csv")
...
temp <- data1112[,c("postViewcount", "likelihood", "postScore", "numAnswer", "numComments", "Favorite", "AnswererReputation", "answererProfileViews", "avg_ans_score", "max_ans_score")]
